    ...
    <div id="rayon-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="{{ route('admin.data-master.store') }}" method="post">
                    @csrf
        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
            ...
            <li class="me-2" role="presentation">
                <button class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-tab" data-tabs-target="#profile"
                    type="button" role="tab" aria-controls="profile" aria-selected="false">Rayon</button>
            </li>
            <li class="me-2" role="presentation">
                <button
                    class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                    id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab"
                    aria-controls="dashboard" aria-selected="false">Rombel</button>
            </li>
        </ul>
    </div>
        ...
        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
            ...
            @if (Session::get('success'))
                <div id="alert-border-1"
                    class="alert flex items-center p-4 mb-4 text-blue-800 border-t-4 border-blue-300 bg-blue-50 dark:text-blue-400 dark:bg-gray-800 dark:border-blue-800"
                    role="alert">
            ...
            <div class="relative overflow-x-auto shadow-sm sm:rounded-lg w-full">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <div
                        ...
                        <form id="search-form" action="{{ route('admin.data-master.index') }}" method="GET"
                            class="mr-2">
