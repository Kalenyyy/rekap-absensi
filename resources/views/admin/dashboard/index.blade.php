...
@section('content')
    ...
    <h1 class="text-center">Laporan Hari & Bulanan</h1>
    <div class="px-10 flex gap-5">
        <div class="w-[70%] mt-10 border-2 rounded-xl h-[500px] p-4"> <!-- Lebar untuk chart bar -->
            <canvas id="myChart"></canvas>
        </div>
        <div class="w-[30%] mt-10 border-2 rounded-xl h-[500px] p-4"> <!-- Lebar untuk chart pie -->
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [65, 59, 80, 81, 56, 55, 60, 70, 85, 90, 75, 50], // Data untuk chart bar
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(255, 159, 64, 0.2)',
                        'rgba(255, 205, 86, 0.2)',
