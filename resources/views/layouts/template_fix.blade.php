...
<body>
    ...
    <body class="body bg-white dark:bg-[#0F172A]">
        <div class="fixed w-full flex bg-white dark:bg-[#0F172A] p-2 items-center justify-center h-16 px-10">
            ...
            <div class="flex-none h-full text-center flex items-center justify-center">
                ...
                <div class="flex space-x-3 items-center px-3">
                    <div class="flex-none flex justify-center">
                        <div class="w-8 h-8  fixed">

                            <button id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar"
                                class="flex fixed text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                                type="button">
